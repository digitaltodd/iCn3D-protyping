...
class SetDialog {
  ...
  setDialogs() {
    ...
    html +=
      '<form method=post enctype=multipart/form-data action="https://www.ncbi.nlm.nih.gov/Structure/vast/VSMmdb.cgi" id="' +
      me.pre +
    ...
    html +=
      me.htmlCls.buttonStr +
      "reload_mmdb_asym'>Load Asymmetric Unit (All Chains)</button>" +
      me.htmlCls.buttonStr +
      "reload_mmdb' style='margin-left:30px'>Load Biological Unit</button><br/><br/><br>";
    html +=
    ...
    html +=
      "The sequence to structure prediction is done via <a href='https://esmatlas.com/resources?action=fold' target='_blank'>ESM Metagenomic Atlas</a>. Generally the sequence should be less than 1024 characters. For any seqeunce longer than 1024, please see the discussion <a href='https://github.com/facebookresearch/esm/issues/21' target='_blank'>here</a>.<br><br> ";
    html +=
    ...
    html +=
      "<b>Note</b>: Always load a PDB file before loading DSN6 files. <br/><br/><br/>";
    ...
    html += this.addNotebookTitle(
      "dl_propbybfactor",
      "Select residues basen on B-factor"
    );
    html +=
