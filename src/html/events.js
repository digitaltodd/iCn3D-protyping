    ...
    me.myEventCls.onIds(
      ...
      async function (e) {
        ...
        if (esmfold_fasta.length > 1024) {
          alert(
            "Your seqeunce is larger than 1024 characters. Please consider to split it as described at https://github.com/facebookresearch/esm/issues/21."
          );
          return;
        }
