...
class SelectCollections {
    ...
    setAtomMenu(nameArray, titleArray) { let  ic = this.icn3d, me = ic.icn3dui;
      let  html = "";
      ...
      for(let i = 0, il = nameArray.length; i < il; ++i) {
          ...
          if(commandnameArray.indexOf(name) != -1) {
            html += "<option value='" + name + "' selected='selected'>" + title + "</option>";
          }
          else {
    ...
    setChainsInMenu() { let  ic = this.icn3d, me = ic.icn3dui;
        ...
        if(ic.structures!=undefined && Object.keys(ic.structures) == 1) {
    ...
    showSets() { let  ic = this.icn3d, me = ic.icn3dui;
        if(!me.bNode) {
            ...
            $("#" + ic.pre + "dl_collectionsMenu").show();
        }
    ...
    clickStructure() { let  ic = this.icn3d, me = ic.icn3dui;
        let thisClass = this;
        //me.myEventCls.onIds("#" + ic.pre + "atomsCustom", "change", function(e) { let  ic = thisClass.icn3d;
        $("#" + ic.pre + "collections_menu").change(function(e) { let  ic = thisClass.icn3d;
           ...
           if(nameArray !== null) {
             ...
             ic.hAtoms = thisClass.getAtomsFromNameArray(nameArray);
             ic.hlUpdateCls.updateHlAll(nameArray, bUpdateHlMenus);
             ic.selectionCls.showSelection();
             me.htmlCls.clickMenuCls.setLogCmd('select structure ' + '[' + nameStructure + ']', true);
             ic.bSelectResidue = false;
           }
        });

        me.myEventCls.onIds("#" + ic.pre + "collections_menu", "focus", function(e) { let  ic = thisClass.icn3d;
           if(me.utilsCls.isMobile()) $("#" + ic.pre + "collections_menu").val("");
        });
    }
