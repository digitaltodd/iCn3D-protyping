  ...
  clickStructure() {
    ...
    $("#" + ic.pre + "collections_menu").change(async function (e) {
      ...
      if (nameArray !== null) {
        ...
        console.log("ic.atoms.length = ", Object.keys(ic.atoms).length);

        ic.dAtoms = {};
        //  ic.ssbondpnts = {};
        let chainIdHash = {};

        console.log(ic.chainsSeq);
        console.log(ic.chains);
        ...
        //  ic.loadPDBCls.setSsbond(chainIdHash)

        ic.transformCls.zoominSelection();

        //  $("#" + ic.pre + "title").html(nameStructure);
