//https://github.com/lh3/bioseq-js/blob/master/bioseq.js
    ...
    function do_align(target, query, match_score, mismatch, gap, extension, is_local=false){
		var time_start = new Date().getTime();

		var rst = bsa_align(is_local, target, query, [match_score, mismatch], [gap, extension]);
		var str = 'score: ' + rst[0] + '\n';
		str += 'start: ' + rst[1] + '\n';
		...
		var anno_seq = document.getElementById("div0_dl_annotations")
		var algn = "<div id=waterman_alignment><span>" + 'score: ' + rst[0] + '<br>' + 'start: ' + rst[1] + '<br>' + 'cigar: ' + bsa_cigar2str(rst[2]) + '<br><br>' + 'alignment:' + '<br>'
