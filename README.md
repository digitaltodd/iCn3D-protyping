# iCn3D Structure Viewer (Distributed)

* Steps to reproduce:
  * Install browser version of iCn3D (v3.4.6) - ` https://www.ncbi.nlm.nih.gov/Structure/icn3d/icn3d-3.4.6.zip`
  * In `\lib\images` add image `ui-bg_gloss-wave_55_5c9ccc_500x100` (from previous builds)
